...
import { abortCauseContext, onCtxAbort, withAbortableSchedule } from '@reatom/effects'
...
export const _onConnect = action((ctx, anAtom: Atom, fn: Fn, controller: AbortController) => {
